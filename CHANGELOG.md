...
-   Added [sphinx-autodoc-typehints](https://github.com/tox-dev/sphinx-autodoc-typehints) package to automatically build documentation based on type annotations in client.py
